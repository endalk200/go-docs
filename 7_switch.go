...
func main() {
	...
	/**
	`interface{}` is the empty interface. Since every type
	implements at least zero methods, every type satisfies
	the empty interface. That means if you write a function
	that takes an empty interface as a parameter, you can supply
